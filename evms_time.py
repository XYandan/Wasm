...
ax.set_ylabel('Time Consumption (ms)', {'family': 'consolas', 'weight': 'normal', 'size': 15})
...
legend = ax.legend(loc='upper left',bbox_to_anchor = (0.71,0.979),fontsize=11)
# plt.title('合约字节码长度比例')
plt.tight_layout()
plt.savefig('./fig/evms_time.pdf', dpi=600, bbox_inches='tight')
plt.show()
